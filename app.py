    ...
    if stock_id:
        ...
        if not ai_reply_text:
            ...
            sys_prompt = (
                ...
                "1. 理論定價：若為『右側多頭』(現價>=MA20)，以CDP壓力或前高為學術推算目標；若為『左側空頭』，以季線(MA60)或反彈位為目標。\n"
                "2. 尊重真實壓力：技術面壓力在哪，推算目標就在哪，嚴禁為了湊數字捏造不切實際的目標價。\n"
                "3. 嚴格評估風報比：請教導學生計算 (目標價-現價) 的獲利空間，以及 (現價-防守價) 的虧損風險。\n"
                "4. 拒絕不合理模型：若潛在獲利不到 10%，或『獲利空間小於虧損風險』，代表此交易模型期望值極差。\n"
                "5. 學術客觀建議：遇到期望值差的狀況，【trend_status】強制選「🟡觀望等待」，且【resistance_level】請誠實填寫『上方壓力太近，風報比不佳建議觀望』，防守價則照常給出。"
            )
