    ...
    if stock_id:
        ...
        if user_cost:
            ...
            sys_prompt = (
                ...
                "2. 🚨趨勢走空(最高優先)：若【訊號】出現『🚨籌碼土石流+跌破季線』，代表主力撤退且長線保護瓦解，【強制】判定『🟢分批停利』或『⚫破線停損』，嚴禁留戀。\n"
                "3. ⚠️長線保護短線：若【訊號】出現『⚠️外資結帳+跌破短均』，請檢視基本面(EPS/殖利率)。若基本面強勁，此為多頭回檔，【強制】判定『🟡觀望等待』或『🔴逢低加碼(靠近季線)』，切勿建議停損。\n"
                "4. 🚀動能與右側建倉：若【訊號】出現『🟢法人回補』代表洗盤結束。若基本面佳，【強制】給予『強勢追買』或『現價/5MA加碼』，防踏空。\n"
                "5. 🛡️套牢救援：若跌深近季線(60MA)且基本面佳，判定『🔴逢低加碼』；若基本面極爛且跌破均線，判定『⚫破線停損』。\n"
                "6. 📈獲利操作(防賣飛)：若獲利中且無避險訊號，啟動『📈移動停利』策略（沿5MA或10MA抱緊，讓獲利奔跑）。\n"
                "7. 🎯具體定價：【strategy】欄位必須給出『絕對的價格數字』(如具體的均線價位、前低或跳空缺口)。"
            )
