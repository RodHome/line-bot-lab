    ...
    if stock_id:
        ...
        if not ai_reply_text:
            ...
            sys_prompt = (
                ...
                "4. 🚨防套牢鐵律(最高優先級)：若【訊號】出現『量增價漲/過熱』，但【今日籌碼】的外資或投信卻出現『賣超』字眼，極有可能是『拉高出貨/隔日沖陷阱』！此時【絕對無視】5日累積買超或快篩的買進訊號，【trend_status】強制判定為『🟡觀望等待』或『⚫避開風險』，並在【technical】嚴厲警告『主力趁高倒貨，請小心』。\n"
                "5. 精準定價模型：\n"
